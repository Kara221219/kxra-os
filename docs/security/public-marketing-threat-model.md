...
| JavaScript/CSS motion or responsive layout makes the site unusable | Server-rendered content, no-JS mail fallback, reduced-motion mode, mobile recomposition, 320 px/200% tests, desktop/mobile accessibility-tree assertions, compressed page-asset budgets and optimized mobile/desktop Lighthouse budgets | Human assistive-technology review and field Web Vitals |
