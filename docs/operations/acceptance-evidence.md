...
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run test:ci`                      | **PASS** — 129/129 database/domain/HTTP/security tests; 57-migration/153-table audit; 38 applicable private-OS browser passes with 4 intentional skips plus 10/10 public-site passes; restart and empty-target restore; both production builds; snapshot/source/artifact and 291-file publication scans |
