...
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run test:ci`                      | **PASS** — 228-package dependency policy; 131/131 database/domain/HTTP/security tests; 57-migration/153-table audit; 38 applicable private-OS browser passes with 4 intentional skips plus 12/12 public-site passes under development and optimized production; restart and empty-target restore; both production builds, exact CSP/SRI, compressed page-asset and optimized Lighthouse budgets; snapshot/source/artifact and 299-file publication scans before the final ADR |
