...
- Transaction-scoped PostgreSQL RLS across all 135 private tables. Request bodies, headers, JWT organization metadata and model output cannot assign identity, tenant, role, project or approval authority.
